  ...
  return <section className="py-16 md:py-24 bg-background">
      <div className="container">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary-hover p-8 md:p-12 lg:p-16 mb-12">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/contact">
                <Button variant="outline" className="border-primary-foreground/30 hover:bg-primary-foreground/10 px-8 py-6 text-lg font-semibold text-primary">
                  Talk to Expert
                </Button>
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => <Link key={feature.title} to={feature.href} className="property-card p-6 group">
